/* ! AdminLTE v3.2.0 (https://adminlte.io) Copyright 2014-2022 Colorlib
 * <https://colorlib.com> Licensed under MIT
...
(function (global, factory) {
   ...
   */
    ...
    var CardRefresh =/*#__PURE__*/
    function () {
        function CardRefresh(element, settings) {
            this._element = element;
            this._parent = element
                .parents(SELECTOR_CARD$1)
                .first();
            ...
            if (this._settings.source === '') {
                throw new Error(
                    'Source url was not defined. Please specify a url in your CardRefresh source op' +
                    'tion.'
                );
            }
        }
            ...
            $__default["default"]
                .get(
                    ...
                    function (response) {
                        ...
                        _this
                            ._settings
                            .onLoadDone
                            .call($__default["default"](_this), response);
                ...
                .fail(function (jqXHR, textStatus, errorThrown) {
                    ...
                    _this
                        ._settings
                        .onLoadFail
                        .call($__default["default"](_this), jqXHR, textStatus, errorThrown);
                });
   ...
   */
    ...
    $__default["default"](document).on(
        ...
        function (event) {
            ...
            CardRefresh
                ._jQueryInterface
                .call($__default["default"](this), 'load');
        }
    );
   ...
   */
    ...
    var CardWidget =/*#__PURE__*/
    function () {
        function CardWidget(element, settings) {
            this._element = element;
            this._parent = element
                .parents(SELECTOR_CARD)
                .first();
        ...
        _proto.collapse = function collapse() {
            ...
            this
                ._parent
                .find(
                    "> " + SELECTOR_CARD_HEADER + " " + this._settings.collapseTrigger + " ." +
            ...
            this
                ._element
                .trigger($__default["default"].Event(EVENT_COLLAPSED$4), this._parent);
        };
        ...
        _proto.expand = function expand() {
            ...
            this
                ._element
                .trigger($__default["default"].Event(EVENT_EXPANDED$3), this._parent);
        };
        ...
        _proto.remove = function remove() {
            ...
            this
                ._element
                .trigger($__default["default"].Event(EVENT_REMOVED$1), this._parent);
        };
        ...
        _proto.maximize = function maximize() {
            ...
            this
                ._element
                .trigger($__default["default"].Event(EVENT_MAXIMIZED), this._parent);
        };
        ...
        _proto.minimize = function minimize() {
            ...
            this
                ...
                .css(
                    'cssText',
                    "height: " + this._parent[0].style.height + " !important; width: " + this._parent[0].style.width +
            ...
            this
                ._element
                .trigger($__default["default"].Event(EVENT_MINIMIZED), this._parent);
        };
   ...
   */
    ...
    $__default["default"](document).on(
        ...
        function (event) {
            ...
            CardWidget
                ._jQueryInterface
                .call($__default["default"](this), 'toggle');
        }
    );
    $__default["default"](document).on(
        'click',
        ...
        function (event) {
            ...
            CardWidget
                ._jQueryInterface
                .call($__default["default"](this), 'remove');
        }
    );
    $__default["default"](document).on(
        'click',
        ...
        function (event) {
            ...
            CardWidget
                ._jQueryInterface
                .call($__default["default"](this), 'toggleMaximize');
        }
    );
    /**
   * jQuery API
   ...
   */
    ...
    function () {
        ...
        _proto.toggle = function toggle() {
            ...
            var shouldClose = $body.hasClass(CLASS_NAME_CONTROL_SIDEBAR_OPEN$1) || $body.hasClass(
                CLASS_NAME_CONTROL_SIDEBAR_SLIDE
            );
            var shouldToggle = notVisible && (
        ...
        _proto._init = function _init() {
            ...
            var $body = $__default["default"]('body');
            var shouldNotHideAll = $body.hasClass(CLASS_NAME_CONTROL_SIDEBAR_OPEN$1) || $body.hasClass(
                CLASS_NAME_CONTROL_SIDEBAR_SLIDE
            );
            ...
            $__default["default"](window).scroll(function () {
                var $body = $__default["default"]('body');
                var shouldFixHeight = $body.hasClass(CLASS_NAME_CONTROL_SIDEBAR_OPEN$1) || $body.hasClass(
                    CLASS_NAME_CONTROL_SIDEBAR_SLIDE
                );
        ...
        _proto._isNavbarFixed = function _isNavbarFixed() {
            var $body = $__default["default"]('body');
            return $body.hasClass(CLASS_NAME_NAVBAR_FIXED) || $body.hasClass(
                CLASS_NAME_NAVBAR_SM_FIXED
            ) || $body.hasClass(CLASS_NAME_NAVBAR_MD_FIXED) || $body.hasClass(
                CLASS_NAME_NAVBAR_LG_FIXED
            ) || $body.hasClass(CLASS_NAME_NAVBAR_XL_FIXED);
        };

        _proto._isFooterFixed = function _isFooterFixed() {
            var $body = $__default["default"]('body');
            return $body.hasClass(CLASS_NAME_FOOTER_FIXED) || $body.hasClass(
                CLASS_NAME_FOOTER_SM_FIXED
            ) || $body.hasClass(CLASS_NAME_FOOTER_MD_FIXED) || $body.hasClass(
                CLASS_NAME_FOOTER_LG_FIXED
        ...
        _proto._fixScrollHeight = function _fixScrollHeight() {
            ...
            var navbarFixed = this._isNavbarFixed() && $__default["default"](
                SELECTOR_HEADER$1
            ).css('position') === 'fixed';
            var footerFixed = this._isFooterFixed() && $__default["default"](
                SELECTOR_FOOTER$1
            ).css('position') === 'fixed';
   ...
   */
    ...
    $__default["default"](document).ready(function () {
        ControlSidebar
            ._jQueryInterface
            .call($__default["default"](SELECTOR_DATA_TOGGLE$4), '_init');
    });
    /**
   * jQuery API
   * ====================================================
    ...
    $__default["default"](SELECTOR_NAVBAR + " " + SELECTOR_DROPDOWN_TOGGLE).on(
        ...
        function (event) {
            ...
            setTimeout(function () {
                Dropdown
                    ._jQueryInterface
                    .call($__default["default"](this), 'fixPosition');
            }, 1);
        }
    );
    /**
   ...
   */
    ...
    */
    ...
    $__default["default"](SELECTOR_TABLE).ready(function () {
        ExpandableTable
            ._jQueryInterface
            .call($__default["default"](this), 'init');
    });
    $__default["default"](document).on(
        'click',
        ...
        function () {
            ExpandableTable
                ._jQueryInterface
                .call($__default["default"](this), 'toggleRow');
        }
    );
    /**
    * jQuery API
   ...
   */
    ...
    */
    ...
    $__default["default"](document).on(EVENT_FULLSCREEN_CHANGE, function () {
        Fullscreen
            ._jQueryInterface
            .call($__default["default"](SELECTOR_DATA_WIDGET$2), 'toggleIcon');
    });
    /**
   * jQuery API
   * ====================================================
   ...
   */
    ...
    var SELECTOR_TAB_NAVBAR_NAV = SELECTOR_CONTENT_WRAPPER + ".iframe-mode .navbar-" +
            "nav";
    var SELECTOR_TAB_NAVBAR_NAV_ITEM = SELECTOR_TAB_NAVBAR_NAV + " .nav-item";
    var SELECTOR_TAB_NAVBAR_NAV_LINK = SELECTOR_TAB_NAVBAR_NAV + " .nav-link";
    var SELECTOR_TAB_CONTENT = SELECTOR_CONTENT_WRAPPER +
   ...
   */
    ...
    function () {
        ...
        _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
            ...
            var newNavItem = "<li class=\"nav-item\" role=\"presentation\"><a href=\"#\" class=\"btn-iframe-" +
                    "close\" data-widget=\"iframe-close\" data-type=\"only-this\"><i class=\"fas fa" +
                    "-times\"></i></a><a class=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "" +
                    "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-s" +
                    "elected=\"false\">" + title + "</a></li>";
            $__default["default"](SELECTOR_TAB_NAVBAR_NAV).append(
                unescape(escape(newNavItem))
            );
            var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabp" +
                    "anel\" aria-labelledby=\"" + navId + "\"><iframe src=\"" + link + "\"></iframe" +
                    "></div>";
        ...
        _proto._init = function _init() {
            var usingDefTab = $__default["default"](SELECTOR_TAB_CONTENT)
                .children()
                .length > 2;
        ...
        _proto._fixHeight = function _fixHeight(tabEmpty) {
            ...
            if ($__default["default"]('body').hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
                ...
                $__default["default"](SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING + ", " +
                        SELECTOR_CONTENT_IFRAME).height(windowHeight - navbarHeight);
   ...
   */
    ...
    $__default["default"](window).on('load', function () {
        IFrame
            ._jQueryInterface
            .call($__default["default"](SELECTOR_DATA_TOGGLE$1));
    });
    /**
   * jQuery API
   * ====================================================
   ...
   */
    ...
    $__default["default"](document).on(
        ...
        function (event) {
            ...
            PushMenu
                ._jQueryInterface
                .call($__default["default"](button), 'toggle');
        }
    );
    $__default["default"](window).on('load', function () {
        PushMenu
            ._jQueryInterface
            .call($__default["default"](SELECTOR_TOGGLE_BUTTON$1));
    });
    /**
   * jQuery API
   * ====================================================
   ...
   */
    ...
    var SELECTOR_SEARCH_RESULTS = "." +
            CLASS_NAME_SEARCH_RESULTS;
    var SELECTOR_SEARCH_RESULTS_GROUP = SELECTOR_SEARCH_RESULTS + " ." +
            CLASS_NAME_LIST_GROUP;
    var Default$4 = {
        arrowSign: '->',
        minLength: 3,
        maxResults: 7,
   ...
   */
    ...
    function () {
        ...
        _proto._renderItem = function _renderItem(name, link, path) {
            ...
            if (this.options.highlightName || this.options.highlightPath) {
                ...
                if (this.options.highlightName) {
                    name = name.replace(regExp, function (str) {
                        return "<strong class=\"" + _this4.options.highlightClass + "\">" + str + "</st" +
                                "rong>";
                    });
                }
            ...
            var searchPathElement = $__default["default"]('<div/>', {class: 'search-path'}).html(
                path
            );
            groupItemElement
   ...
   */
    ...
    $__default["default"](document).on(
        ...
        function (event) {
            ...
            SidebarSearch
                ._jQueryInterface
                .call($__default["default"](SELECTOR_DATA_WIDGET$1), 'toggle');
        }
    );
    $__default["default"](document).on(
        'keyup',
        ...
        function (event) {
            ...
            setTimeout(function () {
                SidebarSearch
                    ._jQueryInterface
                    .call($__default["default"](SELECTOR_DATA_WIDGET$1), 'search');
            }, 100);
        }
    );
    $__default["default"](document).on(
    ...
    $__default["default"](window).on('load', function () {
        SidebarSearch
            ._jQueryInterface
            .call($__default["default"](SELECTOR_DATA_WIDGET$1), 'init');
    });
    /**
   * jQuery API
   * ====================================================
   ...
   */
    ...
    $__default["default"](window).on('load', function () {
        TodoList
            ._jQueryInterface
            .call($__default["default"](SELECTOR_DATA_TOGGLE));
    });
    /**
   * jQuery API
   * ====================================================
    ...
    function () {
        ...
        _proto.expand = function expand(treeviewMenu, parentLi) {
            ...
            if (this._config.accordion) {
                var openMenuLi = parentLi
                    .siblings(SELECTOR_OPEN)
                    .first();
        ...
        _proto.collapse = function collapse(treeviewMenu, parentLi) {
            ...
            treeviewMenu
                ...
                .slideUp(this._config.animationSpeed, function () {
                    ...
                    treeviewMenu
                        .find(
                            SELECTOR_OPEN + " > " + SELECTOR_TREEVIEW_MENU
                        )
                        .slideUp();
                    treeviewMenu
                        .find(SELECTOR_OPEN)
